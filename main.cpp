...
/*****************************************************************************
This function, test_imge(), shows you how to load and "blit" an image. "Blit"
...
void test_image()
{
	...
	Image image("images/galaxian/brain_fire3.png");	// loads image
...
/*************************************************************
           ...
           My attempt at puting a space ship down
...
void test_ship()
{
    Surface surface(W, H);
    Event event;
    Image image = "images/galaxian/SpaceShip3.png";
    Image brain = "images/galaxian/Brain.png";
    int Fleet::speed(5);
    Ship test (W / 2, H / 2 + 150, surface, image);   
    ...
    for(int i = 0; i < 4; ++i)
    {
        Fleet alien(0,0,surface,brain);
        Fleet alien2(50,0,surface,brain);
        Fleet alien3(100,0,surface,brain);
        Fleet alien4(150,0,surface,brain);
        Brain_ship.push_back(alien);
        Brain_ship.push_back(alien2);
        Brain_ship.push_back(alien3);
        Brain_ship.push_back(alien4);
    }
